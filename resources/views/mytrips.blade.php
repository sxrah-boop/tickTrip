...
<h1 class="text-center px-2 py-2">My Trips</h1>
<section class="h-100">
        ...
        <div class=" py-4 rounded-4" style="background-color: #380094;width: 95%;">
            <div class="container d-flex align-items-center justify-content-center ">
                 <div class="d-flex flex-column gap-2" id="trip-cards-container" style="width:70%;">
                    ...
                    <p class="text-secondary mb-0 pb-0"><span>{{ $trip->heure_depart }}</span> <span></span></p>
                    ...
                    <div class=" d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-people-fill me-2"></i>{{ $trip->place_disponibles }}
                        </div>
